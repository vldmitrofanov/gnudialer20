...
//	int m1 		= atoi(TheFields.GetField("mon1").c_str());
//	int d1 		= atoi(TheFields.GetField("day1").c_str());
//	int y1 		= atoi(TheFields.GetField("year1").c_str());
//	int m2 		= atoi(TheFields.GetField("mon2").c_str());
//	int d2 		= atoi(TheFields.GetField("day2").c_str());
//	int y2 		= atoi(TheFields.GetField("year2").c_str());
...
//*******************
        		std::cout << "<table border=0 cellpadding=3 cellspacing=0><tr><td>" << selection << "&nbsp;&nbsp;&nbsp;&nbsp;" << std::endl;
...
//	} else {
//		std::cout << "Date range doesn't make sense!" << std::endl;
	}
